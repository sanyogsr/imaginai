      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-6 text-gray-600">
          ...
          <section className="bg-white rounded-2xl p-8 shadow-sm">
            ...
            <p className="mb-4">
              Think of each credit as a unique moment of creativity - once
              it&apos;s transformed into pixels, that magical moment can&apos;t
              be reversed. This policy helps us maintain the quality and
              reliability of our service while keeping costs reasonable for all
              users.
            </p>
          </section>
          ...
          <section className="bg-white rounded-2xl p-8 shadow-sm">
            ...
            <p className="mb-4">
              ...
              you&apos;re encountering any issues or need guidance, please
