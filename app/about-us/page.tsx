        ...
        <div className="space-y-6 text-gray-600">
          ...
          <section className="bg-white rounded-2xl p-8 shadow-sm">
            ...
            <div className="flex items-start space-x-6">
              <div className="w-24 h-24 rounded-lg bg-gradient-to-br from-purple-600 to-blue-500 flex items-center justify-center">
                <span className="text-white font-bold text-xl">S</span>
              </div>
              <div>
                <h3 className="text-xl font-semibold text-gray-800">Sanyog</h3>
                ...
                <p className="text-gray-600">
                  ...
                  make high-quality AI image generation accessible to everyone.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-4">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>Flux - Ultra-high resolution outputs</li>
                  <li>Schnell - Lightning-fast generation</li>
                  <li>Dev - Experimental features</li>
                  <li>Pro - Professional-grade quality</li>
                </ul>
              </div>
              <div className="space-y-4">
                <h3 className="text-xl font-semibold text-purple-600">
          ...
          <section className="bg-white rounded-2xl p-8 shadow-sm">
            ...
            <p className="mb-4">
              ...
              generation while maintaining the highest standards of quality and
              user experience. Our team continuously works on improving our
              models and adding new features to meet the evolving needs of our
              creative community.
            </p>
          </section>
